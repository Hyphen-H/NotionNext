...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '欢迎来到我的博客，希望你能得到奇奇怪怪的芝士',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hyphen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'INTP', // 作者简介
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || '',
  // 字体CSS 例如 https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css
  FONT_URL: [
    // 'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css',
    'https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/styles/LXGWB.css',
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/spoiler.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  CUSTOM_EXTERNAL_CSS: ['https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/spoiler.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/styles/hyphen-code-light.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/styles/hyphen-code-light.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://cdn.jsdelivr.net/gh/Hyphen-H/NotionNext@main/styles/hyphen-code-dark.css', // 深色模式主题
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/analytics/quickstart https://github.com/tangly1024/NotionNext/issues/897
